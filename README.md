...
基于计算机视觉的自动化测试模型构建技术
P1：
传统方法：由人进行自动化测试建模，需求编写人员需要投入大量精力和时间以理解应用中各个可视元素的功能；同时，人的视角通常聚集在某一功能的测试，缺少全局视野，对应用的测试覆盖率产生潜在影响。

我们的方法：基于计算机视觉，识别应用中的按钮、文本提示等ui元素，形成
自动化构建测试模型，提高测试覆盖率和测试效率
